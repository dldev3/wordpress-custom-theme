...
<head>
    ...
    <meta name="description" content="test blog site in wordpress">
...
<header class="header text-center">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark" >
        ...
        <div id="navigation" class="collapse navbar-collapse flex-column" >
            <img class="mb-3 mx-auto logo" src="<?= get_template_directory_uri().'/assets/images/logo.png' ?>" alt="logo" >
...
<div class="main-wrapper">
            ...
            <div id="carouselExampleControls" class="carousel slide" data-ride="carousel">
                <div class="carousel-inner">
                    <div class="carousel-item active">
                        <img src="<?= get_template_directory_uri().'/assets/images/slider2.jpg' ?>" class="d-block w-100" alt="1">

                    </div>
                    <div class="carousel-item">
                        <img src="<?= get_template_directory_uri().'/assets/images/slider1.jpg' ?>" class="d-block w-100" alt="2">
                    </div>
                    <div class="carousel-item">
                        <img src="<?= get_template_directory_uri().'/assets/images/slider3.jpg' ?>" class="d-block w-100" alt="3">
                    </div>
                </div>
    ...
    <footer class="footer text-center py-2 theme-bg-dark">
        ...
        <p class="copyright"><a href="https://youtube.com/FollowAndrew">MCLABS</a></p>
